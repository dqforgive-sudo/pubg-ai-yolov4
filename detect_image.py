...
def parser():
    ...
    parser.add_argument("--input", type=str, default="./img/pubg.png",
    ...
    parser.add_argument("--weights", default="./weights/pubg.weights",
    ...
    parser.add_argument("--config_file", default="./cfg/pubg.cfg",
                        help="path to config file")
    parser.add_argument("--data_file", default="./cfg/pubg.data",
